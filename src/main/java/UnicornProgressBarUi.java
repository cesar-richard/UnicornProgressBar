...
public class UnicornProgressBarUi extends BasicProgressBarUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new UnicornProgressBarUi();
    }
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) UnicornIcons.UNICORN_ICON) : ((ScalableIcon) UnicornIcons.REVERSED_UNICORN_ICON);
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        UnicornIcons.UNICORN_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
